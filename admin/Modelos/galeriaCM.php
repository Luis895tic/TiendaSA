...
class GaleriaCM extends ConexionBD{
	...
	static public function CrearGaleriaCM($tablaBD, $datosC){
	...
	//Ver Galería
	static public function VerGaleriaCM($tablaBD, $item, $valor){
	...
	//Borrar Imagen
	static public function BorrarGaleriaCm($tablaBD, $id){
	...
	//Actualizar Galería
	static public function ActualizarGaleriaCM($tablaBD, $datosC){
