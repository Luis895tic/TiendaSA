...
class GaleriaAM extends ConexionBD{
	...
	static public function CrearGaleriaAM($tablaBD, $datosC){
	...
	//Ver Galería
	static public function VerGaleriaAM($tablaBD, $item, $valor){
	...
	//Borrar Imagen
	static public function BorrarGaleriaAm($tablaBD, $id){
	...
	//Actualizar Galería
	static public function ActualizarGaleriaAM($tablaBD, $datosC){
