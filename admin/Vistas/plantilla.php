...
<body class="hold-transition skin-blue sidebar-mini login-page">
  ...
  if(isset($_SESSION["Ingreso"]) && $_SESSION["Ingreso"] == true){
    ...
    if(isset($_GET["url"])){
      ...
      if($_GET["url"] == "inicio" || $_GET["url"] == "ingreso" || $_GET["url"] == "usuarios" || $_GET["url"] == "salir" || $_GET["url"] == "perfil" || $_GET["url"] == "slide" || $_GET["url"] == "nosotros"  || $_GET["url"] == "mensajes" || $_GET["url"] == "hsimple" || $_GET["url"] == "hsimpleF" || $_GET["url"] == "hsimpleP" || $_GET["url"] == "hsimpleA" || $_GET["url"] == "galeriac" || $_GET["url"] == "galerial" || $_GET["url"] == "galeriaf" || $_GET["url"] == "galeriaa"){
...
<script src="Vistas/js/galeriac.js"></script>
<script src="Vistas/js/galerial.js"></script>
<script src="Vistas/js/galeriaf.js"></script>
<script src="Vistas/js/galeriaa.js"></script>
