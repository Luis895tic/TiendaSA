  ...
  if(respuesta==true){
    ...
    return false;
            ...
            <tbody>
              ...
              $verG = GaleriaAC::VerGaleriaAC($item, $valor);
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          $crearG = new GaleriaAC();
          $crearG -> CrearGaleriaAC();
...
<div class="modal fade" role="dialog" id="EditarGaleria">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          <div class="modal-body">
           ...
           <div class="box-body">
            ...
            <div class="form-group">
              ...
              <img src="Vistas/img/galeriaa" class="img-thumbnail visor" width="300px;"> 
          ...
          $actualizarG = new GaleriaAC();
          $actualizarG -> ActualizarGaleriaAC();
  ...
  $borrarG = new GaleriaAC();
  $borrarG -> BorrarGaleriaAC();
