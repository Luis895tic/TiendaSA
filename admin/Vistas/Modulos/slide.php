                ...
                echo '<tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <button onclick="return confirmacion()" class="btn btn-danger BorrarSlide" Sid="'.$value["id"].'" imagenSlide="'.$value["imagen"].'"><i class="fa fa-times" ></i></button>
          ...
          <div class="modal-body">
           ...
           <div class="box-body">
            ...
            <div class="form-group">
              ...
              <textarea id="descripcionE" name="descripcionE" require="">
            ...
            <div class="form-group">
              ...
              <input type="file" id="imagenE" name="imagenE" require="">
