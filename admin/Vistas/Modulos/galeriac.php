  ...
  if(respuesta==true){
    ...
    return false;
            ...
            <tbody>
              ...
              $verG = GaleriaCC::VerGaleriaCC($item, $valor);
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          $crearG = new GaleriaCC();
          $crearG -> CrearGaleriaCC();
...
<div class="modal fade" role="dialog" id="EditarGaleria">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          $actualizarG = new GaleriaCC();
          $actualizarG -> ActualizarGaleriaCC();
  ...
  $borrarG = new GaleriaCC();
  $borrarG -> BorrarGaleriaCC();
