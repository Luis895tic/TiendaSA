<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Gestor galeria de frutas y verduras
      </h1>
  ...
  if(respuesta==true){
    ...
    return false;
            ...
            <tbody>
              ...
              $verG = GaleriaFC::VerGaleriaFC($item, $valor);
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          $crearG = new GaleriaFC();
          $crearG -> CrearGaleriaFC();
...
<div class="modal fade" role="dialog" id="EditarGaleria">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          $actualizarG = new GaleriaFC();
          $actualizarG -> ActualizarGaleriaFC();
  ...
  $borrarG = new GaleriaFC();
  $borrarG -> BorrarGaleriaFC();
