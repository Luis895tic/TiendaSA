          ...
          <div class="modal-body">
           ...
           <div class="box-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control input-lg" name="rolN" required="">
          ...
          <div class="modal-body">
           ...
           <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="file" id="fotoE" name="fotoE" required="">

              <p class="help-block">peso máximo permitido 200 MB</p>

              <img src="Vistas/img/usuarios" class="img-thumbnail visor" width="100px;"> 
