			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
				...
				<div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link scroll" href="#depa">Productos</a>
						</li>
...
<!--Slider-->
		...
		include "Vistas/modulos/galeriac.php";

		include "Vistas/modulos/productosF.php";

		include "Vistas/modulos/galeriaf.php";

		include "Vistas/modulos/productosP.php";

		include "Vistas/modulos/galerial.php";

		include "Vistas/modulos/productosA.php";

		include "Vistas/modulos/galeriaa.php";
		...
		<script>
			function mostrara(){
				document.getElementById('gallerya').style.display='block';
			}

			function ocultara(){
				document.getElementById('gallerya').style.display='none';
			}
		</script>

		<script>
			function mostrarl(){
				document.getElementById('galleryl').style.display='block';
			}

			function ocultarl(){
				document.getElementById('galleryl').style.display='none';
			}
		</script>

		<script>
			function mostrarf(){
				document.getElementById('galleryf').style.display='block';
			}

			function ocultarf(){
				document.getElementById('galleryf').style.display='none';
			}
		</script>

		<script>
			function mostrarc(){
				document.getElementById('galleryc').style.display='block';
			}

			function ocultarc(){
				document.getElementById('galleryc').style.display='none';
			}
		</script>
